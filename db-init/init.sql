...
CREATE TABLE "courses" (
  ...
  "semester" VARCHAR(30) NOT NULL DEFAULT 'HK2 2025-2026',
  "credit" INTEGER NOT NULL DEFAULT 3,
  "course_type" VARCHAR(20) NOT NULL DEFAULT 'Bắt buộc',
  "created_at" TIMESTAMPTZ NOT NULL DEFAULT CURRENT_TIMESTAMP
);
...
INSERT INTO courses (course_code, course_name, group_code, capacity, lecturer_name, day_of_week, start_time, end_time, level)
VALUES ('CO1027', 'Programming Fundamentals', 'L01', 80, 'Nguyen Van A', 'MONDAY', '07:00', '09:30', 'Undergraduate');

INSERT INTO courses (course_code, course_name, group_code, capacity, lecturer_name, day_of_week, start_time, end_time, level)
VALUES ('CO2003', 'Data Structures and Algorithms', 'CC01', 60, 'Le Thi B', 'WEDNESDAY', '13:00', '15:30', 'Undergraduate');

INSERT INTO courses (course_code, course_name, group_code, capacity, lecturer_name, day_of_week, start_time, end_time, level)
VALUES ('CO3005', 'Computer Networks', 'L03', 50, 'Tran Van C', 'THURSDAY', '09:00', '11:30', 'Undergraduate');

INSERT INTO courses (course_code, course_name, group_code, capacity, lecturer_name, day_of_week, start_time, end_time, level)
VALUES ('CO4029', 'Artificial Intelligence', 'CC02', 40, 'Pham Thi D', 'FRIDAY', '07:00', '09:30', 'Undergraduate');

INSERT INTO courses (course_code, course_name, group_code, capacity, lecturer_name, day_of_week, start_time, end_time, level)
VALUES ('CO4001', 'Machine Learning', 'CC01', 30, 'Dr. Alan Turing', 'TUESDAY', '13:00', '16:00', 'Graduate');

INSERT INTO courses (course_code, course_name, group_code, capacity, lecturer_name, day_of_week, start_time, end_time, level)
VALUES ('MT1003', 'Calculus 1', 'L05', 100, 'Isaac Newton', 'MONDAY', '15:00', '17:30', 'Undergraduate');

INSERT INTO courses (course_code, course_name, group_code, capacity, lecturer_name, day_of_week, start_time, end_time, level)
VALUES ('PH1003', 'General Physics 1', 'L01', 80, 'Albert Einstein', 'WEDNESDAY', '07:00', '09:30', 'Undergraduate');

INSERT INTO courses (course_code, course_name, group_code, capacity, lecturer_name, day_of_week, start_time, end_time, level)
VALUES ('EN1001', 'English 1', 'E01', 30, 'Jane Austen', 'THURSDAY', '13:00', '15:00', 'Undergraduate');

INSERT INTO courses (course_code, course_name, group_code, capacity, lecturer_name, day_of_week, start_time, end_time, level)
VALUES ('CO3099', 'Web Application Development', 'CC01', 40, 'Tim Berners-Lee', 'FRIDAY', '15:00', '17:30', 'Undergraduate');
...
-- =====================================================
-- ADMIN FEATURES - Thêm user Academic Office mẫu
-- =====================================================

INSERT INTO users (email, password_hash, full_name, role)
VALUES ('academic@mail.com', '$2b$10$W5oS4Ix84ndGU3qKQoVRoufnuUnsBu3RT5WqPdPz5xLaqRtFNptEW', 'Academic Office', 'ACADEMIC_OFFICE')
ON CONFLICT (email) DO NOTHING;

-- Tạo view thống kê đăng ký theo môn học (dùng cho admin dashboard)
...
SELECT
  ...
  c.course_name,
  c.capacity,
  COUNT(CASE WHEN e.status = 'SUCCESS' THEN 1 END) AS enrolled,
  COUNT(CASE WHEN e.status = 'PENDING' THEN 1 END) AS pending,
  c.capacity - COUNT(CASE WHEN e.status = 'SUCCESS' THEN 1 END) AS available
FROM courses c
LEFT JOIN enrollments e ON c.id = e.course_id
GROUP BY c.id, c.course_code, c.course_name, c.capacity;
